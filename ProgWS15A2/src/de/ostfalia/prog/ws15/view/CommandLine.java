...
public class CommandLine {
     ...
     */
    public static Grid execute(Reader reader) {
        Grid grid = null;
     ...
     */
    private static void executeO(Grid grid) {
        try {
     ...
     */
    private static void executeQ(Grid grid, String line) {
        try {
     ...
     * @param line operation
     */
    private static void executeI(Grid grid, String line) {
        try {
     ...
     * @param line operation
     */
    private static void executeR(Grid grid, String line) {
        try {
     ...
     * @param grid target grid
     */
    private static void executeS(Grid grid) {
        try {
            grid.update();
            return;
        } catch (NullPointerException e) {
     ...
     * @param line operation
     */
    private static void executeC(Grid grid, String line) {
        try {
        ...
        } catch (Grid.IllegalCellTypeException |
