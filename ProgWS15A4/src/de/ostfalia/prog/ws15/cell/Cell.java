...
public abstract class Cell {
    ...
    /**
     * getter for state attribute of the cell
     *
    ...
    /**
     * returns the orientation integer
     *
    ...
    public void update(GridImpl grid, int row, int column) {
        switch (this.orientation) {
            case '>':
                if (column > 0 && grid.cells[row][column - 1] != null
            ...
            case '<':
                ...
                break;
            default://case 'v'
                if (row > 0 && grid.cells[row - 1][column] != null &&
                        grid.cells[row - 1][column]
